    ...
    <html lang="en" className={` ${raleway.className}`}>
      <body className='min-h-screen flex flex-col'>
        ...
        <footer className="flex-none">
          <div className='text-neutral-content flex place-content-evenly bg-opacity-5 p-10' style={{position: 'relative', bottom: '0px', width: '100%'}}>
            ...
            <div className="text-center">
              <p>
                <Link href="https://orcid.org/my-orcid?orcid=0009-0005-9727-559X" target="_blank" rel="noopener noreferrer">
