    ...
    <div className="flex flex-col items-center justify-center">
      <div>
        ...
        <div className='w-full mx-auto sm:w-full md:w-3/4 lg:w-3/4 xl:w-3/4'>
          <p className='m-3 mt-2 p-6 rounded border border-black border-opacity-0 dark:border-opacity-0 dark:border-white hover:bg-opacity-5 hover:border-opacity-20 hover:-opacity-90 hover:translate-x-1 hover:translate-y-1'>
