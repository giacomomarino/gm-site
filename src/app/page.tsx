      ...
      <div>
        ...
        <div className="flex flex-col sm:flex-row sm:flex-wrap mb-2 justify-center">
          <div className="w-full sm:w-2/3 md:w-2/4 lg:w-2/4 p-3">
            ...
            I&apos;m a full-stack developer specializing in bioinformatics.  I graduated from Brown University in 2022 with an <i>ScB</i> in Neuroscience and an <i>AB</i> in Computer Science. I spent three years as a{" "}
