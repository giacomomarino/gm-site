...
export default function CardGrid({ colLength, maxrows }: { colLength: number, maxrows: number }) {
    ...
    if (colLength === 1) {
        return (
            <div className="justify-center p-10 pt-0 pb-0" style={{ display: "flex col", container: "initial", gridRow: "auto" }}>
    ...
    return (
        <div className="flex-wrap lg:flex xl:flex justify-center">
            <div className="pt-0" style={{ display: "flex col", container: "initial", gridRow: "auto" }}>
            ...
            <div className="pt-0 lg:pl-6" style={{ display: "flex col", container: "initial", gridRow: "auto" }}>
                {manifest.map((project, index) => {
